...
export const FriendRequestSidebar = (props: IFriendRequestSidebarModel) => {
    ...
    return (
        <Link href="/dashboard/requests" className="tw-text-gray-700 hover:tw-text-indigo-600 hover:tw-bg-gray-50 tw-group tw-flex tw-items-center tw-gap-x-3 tw-rounded-md tw-text-sm tw-p-2 tw-leading-6 tw-font-semibold">
